...
All booked lecture halls according to the corresponding events:<br/><br/><br/><br/>
...
<br/><br/><br/>
<form action="book.php" name="event_selection">
<table style="border:1px; margin-left:auto;margin-right:auto;" border="1" cellpadding="10" cellspacing="0">
<tr>
...
<td>
<select name=Lecturehall  style="width:70px; margin-right:0;float:right;position:relative;">
...
E-mail&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <input type="text" size="20"style="margin-left:20px;position:absolute;"><br><br/>
